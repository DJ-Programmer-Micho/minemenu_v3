...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{asset('assets/general/logo/57.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="{{asset('assets/general/logo/57.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="{{asset('assets/general/logo/57.png')}}">
    <link rel="apple-touch-icon-precomposed" sizes="57x57" href="{{asset('assets/general/logo/57.png')}}">
    <link rel="apple-touch-icon-precomposed" href="{{asset('assets/general/logo/57.png')}}">
    <!-- end of icons -->
    {{-- Title --}}
