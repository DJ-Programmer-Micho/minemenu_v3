...
<head>
    ...
    <title>Mine Menu | Resturant</title>
    <!-- BEGIN: CSS Assets-->
...
<lord-icon
    ...
    style="width:48px;height:48px">
        ...
        <div class="content">
            ...
            <div class="top-bar">
                <!-- BEGIN: Breadcrumb -->
                <div class="-intro-x breadcrumb mr-auto hidden sm:flex"> <a href="/rest" class="">Main Menu</a> <i
                        data-feather="chevron-right" class="breadcrumb__icon"></i> <a href=""
                        class="breadcrumb--active">@yield('tail','')</a> </div>
                <!-- END: Breadcrumb -->
                <!-- BEGIN: Search -->
                    ...
                    <div class="dropdown-box w-56">
                        <div class="dropdown-box__content box bg-theme-38 dark:bg-dark-6 text-white">
                            <div class="p-4 border-b border-theme-40 dark:border-dark-3">
                                <div class="font-medium">{{auth()->user()->profile->fullname}}</div>
                                <div class="text-xs text-theme-41 dark:text-gray-600">{{__('Returant Owner')}}</div>
                            </div>
                            <div class="p-2">
                                ...
                                <a href=""
                                    class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                                    <i data-feather="edit" class="w-4 h-4 mr-2"></i> {{__('Add Employee')}} </a>
                                <a href=""
                                    class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                                    <i data-feather="lock" class="w-4 h-4 mr-2"></i> {{__('Reset Password')}} </a>
                            </div>
                            <div class="p-2 border-t border-theme-40 dark:border-dark-3">
                                <a href="{{route('logout')}}"
                                    class="flex items-center block p-2 transition duration-300 ease-in-out hover:bg-theme-1 dark:hover:bg-dark-3 rounded-md">
                                    <i data-feather="toggle-right" class="w-4 h-4 mr-2"></i> {{__('Logout')}} </a>
                            </div>
                        </div>
                    </div>
                </div>
